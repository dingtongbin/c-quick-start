      ...
      '/guide/基础语法/': [
        {
          text: '基础语法',
          items: [
            { text: '第1章：C语言入门基础', link: '/guide/基础语法/第1章：C语言入门基础' },
            { text: '第2章：数据类型与变量', link: '/guide/基础语法/第2章：数据类型与变量' },
            { text: '第3章：运算符与表达式', link: '/guide/基础语法/第3章：运算符与表达式' },
            { text: '第4章：流程控制语句', link: '/guide/基础语法/第4章：流程控制语句' },
            { text: '第5章：数组与字符串', link: '/guide/基础语法/第5章：数组与字符串' },
            { text: '第6章：函数', link: '/guide/基础语法/第6章：函数' },
            { text: '第7章：指针基础', link: '/guide/基础语法/第7章：指针基础' },
            { text: '第8章：结构体与共用体', link: '/guide/基础语法/第8章：结构体与共用体' },
            { text: '第9章：预处理指令', link: '/guide/基础语法/第9章：预处理指令' },
            { text: '第10章：文件操作', link: '/guide/基础语法/第10章：文件操作' },
            { text: '第11章：内存管理', link: '/guide/基础语法/第11章：内存管理' },
            { text: '第12章：综合实战项目', link: '/guide/基础语法/第12章：综合实战项目' }
          ]
        }
      ],
      '/guide/数据结构/': [
